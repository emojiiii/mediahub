...
const backendApi: Api = {
  ...
  async updateWebhook(id, input) { const value = await backendData(backendClient.PATCH('/api/v1/webhooks/{webhook_id}', { params: { path: { webhook_id: id } }, body: { ...input, rotate_secret: false } })); return webhookFromBackend(value.endpoint) },
